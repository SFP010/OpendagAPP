...
public class Communicatie3 extends AppCompatActivity {
    Button copen;
    Button share;
    Button question;
    Button route;
    ...
    String shareBody = "Hi, 4th of April there is an open day of Communicatie, would you like to come with me? The address is Rotterdam Wijnhaven 107.";
    String shareSub = "Openday";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.communicatie3);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final PopupMenu shareIt = new PopupMenu(Communicatie3.this, share);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (share_id == R.id.e_mail) {
                            ...
                            if (emailIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(Communicatie3.this, "Email not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (wappIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(Communicatie3.this, "Whatsapp not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (twitterIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(Communicatie3.this, "Twitter not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (facebookIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(Communicatie3.this, "Facebook not installed", Toast.LENGTH_SHORT).show();
                            }
                        }
                        return true;
                    }
        ...
        question.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Communicatie3.this, questionform.class ));
            }
        });
        ...
        route.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Communicatie3.this, Route.class));
            }
        });
    }
    @Override
