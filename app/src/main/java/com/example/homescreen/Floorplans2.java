...
public class Floorplans2 extends AppCompatActivity {
    Button HR_99;
    Button HR_103;
    Button HR_107;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.floorplans2);

        PhotoView photoView = findViewById(R.id.Plattegrond1);
        photoView.setImageResource(R.drawable.bg103);

        final ImageView imageView = (ImageView) findViewById(R.id.Plattegrond1);
        imageView.setImageResource(R.drawable.bg103);
        ...
        FloorButton1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                imageView.setImageResource(R.drawable.floor1_103);
            }
        });
        ...
        FloorButton2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                imageView.setImageResource(R.drawable.floor2_103);
            }
        });
        ...
        FloorButton3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                imageView.setImageResource(R.drawable.floor3_103);
            }
        });
        ...
        FloorButton4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                imageView.setImageResource(R.drawable.floor4_103);
            }
        });
        ...
        FloorButton5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                imageView.setImageResource(R.drawable.floor5_103);
            }
        });
        ...
        FloorButton6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                imageView.setImageResource(R.drawable.floor6_103);
            }
        });
