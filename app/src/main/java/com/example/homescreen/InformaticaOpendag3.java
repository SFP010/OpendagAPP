...
public class InformaticaOpendag3 extends AppCompatActivity {
    Button copen;
    Button share;
    Button question;
    Button route;
    ...
    String shareBody = "Hi, 4th of April there is an open day of Informatica, would you like to come with me? The address is Rotterdam Wijnhaven 107.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final PopupMenu shareIt = new PopupMenu(InformaticaOpendag3.this, share);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (share_id == R.id.e_mail) {
                            ...
                            if (emailIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(InformaticaOpendag3.this, "Email not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (wappIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(InformaticaOpendag3.this, "Whatsapp not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (twitterIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(InformaticaOpendag3.this, "Twitter not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (facebookIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(InformaticaOpendag3.this, "Facebook not installed", Toast.LENGTH_SHORT).show();
                            }
                        }
                        return true;
                    }
        ...
        copen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String startDate = "2019-04-04-13-15";
        ...
        question.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(InformaticaOpendag3.this, questionform.class ));
            }
        });
        ...
        route.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(InformaticaOpendag3.this, Route.class));
            }
        });
    }
    @Override
