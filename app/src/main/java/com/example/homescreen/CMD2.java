...
public class CMD2 extends AppCompatActivity {
    Button copen;
    Button share;
    Button question;
    Button route;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final PopupMenu shareIt = new PopupMenu(CMD2.this, share);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (share_id == R.id.e_mail) {
                            ...
                            if (emailIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(CMD2.this, "Email not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (wappIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(CMD2.this, "Whatsapp not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (twitterIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(CMD2.this, "Twitter not installed", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (facebookIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(CMD2.this, "Facebook not installed", Toast.LENGTH_SHORT).show();
                            }
                        }
                        return true;
                    }
        ...
        route.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CMD2.this, Route.class));
            }
        });
    }
    @Override
